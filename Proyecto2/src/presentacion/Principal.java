...
public class Principal {
    ...
    private void caso1() {
        ...
        sistema.getLog().log(admin.getCorreo(), LogEntrada.Tipo.OFERTA_PUBLICADA,
        ...
        sistema.getLog().log(admin.getCorreo(), LogEntrada.Tipo.VENTA_COMPLETADA,
        ...
        sistema.getLog().log(org.getCorreo(), LogEntrada.Tipo.OFERTA_PUBLICADA,
        ...
        sistema.getLog().log(c1.getCorreo(), LogEntrada.Tipo.COMPRA_DIRECTA,
                "Cliente " + c1.getCorreo() + " compró tiquete " + t1.getId());

        c1.transferirTiquete(t1, c2, "pass1");
        sistema.getLog().log(c1.getCorreo(), LogEntrada.Tipo.VENTA_COMPLETADA,
        ...
        sistema.getLog().log(admin.getCorreo(), LogEntrada.Tipo.OFERTA_CANCELADA,
    ...
    private void caso2() {
        ...
        c.setSaldo(50);
        sistema.getLog().log(c.getCorreo(), LogEntrada.Tipo.OFERTA_PUBLICADA,
                "Cliente creado con saldo inicial 50");

        Tiquete t = l.getTiquetes().get(0);
        c.comprarTiquete(t);
        sistema.getLog().log(c.getCorreo(), LogEntrada.Tipo.COMPRA_DIRECTA,
        ...
        sistema.getLog().log(c.getCorreo(), LogEntrada.Tipo.CONTRAOFERTA_RECHAZADA,
                "Cliente " + c.getCorreo() + " intentó transferir con clave incorrecta.");

        c.transferirTiquete(t, c2, "1112");
        sistema.getLog().log(c.getCorreo(), LogEntrada.Tipo.VENTA_COMPLETADA,
